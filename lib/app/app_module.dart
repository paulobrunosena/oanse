...
import 'shared/repositories/auth_hive_repository.dart';
import 'shared/repositories/auth_repository.dart';
import 'shared/repositories/club_repository.dart';
import 'shared/repositories/interfaces/auth_hive_repository_interface.dart';
...
class AppModule extends Module {
  ...
  final List<Bind> binds = [
    Bind.lazySingleton((i) => AuthHiveService(i<IAuthHiveRepository>())),
    Bind.lazySingleton((i) => AuthHiveRepository()),
  ...
  final List<ModularRoute> routes = [
    ...
    ModuleRoute(routeLoginLeadership, module: LoginLeadershipModule()),
