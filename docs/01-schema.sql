...
-- Catálogo da Folha de Progresso Individual — Faíscas (docs/06-folha-individual.md)
-- 3 manuais (Saltador/Caminhante/Escalador) × 12 blocos = 36 blocos; a seção
-- Observações não tem itens (tipo = 'observacoes').
do $$
declare
  v_clube  uuid;
  v_manual uuid;
