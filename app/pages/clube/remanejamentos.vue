...
import type { TurmaRemanejamento } from '~/composables/useRemanejamentos'

definePageMeta({ middleware: ['role'], roles: ['diretor_clube'] })
useSeoMeta({ title: 'Remanejamentos — Oanse' })
        ...
        >
          <div class="flex items-center justify-between gap-3 mb-3">
            ...
            <UBadge
              ...
              color="warning"
            >
              Substituto: {{ substitutoNome(t.id) }}
            </UBadge>
          </div>
          ...
          <div class="flex items-end gap-2">
            <div class="flex-1">
              <USelect
                ...
                :items="opcoesSubstituto(t.id, t.lider_id)"
