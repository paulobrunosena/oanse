...
- [x] UX do módulo: busca de criança no evento lista só os clubes participantes (badge do clube nas opções); excluir evento dentro do card (não "flutua" fora); refresh após ações não derruba o scroll da página (mantém conteúdo montado)
