...
const rotas: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'clube/folha-individual', name: 'clube-folha-individual', component: () => import('@/views/clube/FolhaIndividualView.vue'), meta: { roles: ['diretor_geral', 'diretor_clube', 'lider'] } },
