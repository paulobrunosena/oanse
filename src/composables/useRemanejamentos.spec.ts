...
describe('useRemanejamentos', () => {
  ...
  describe('carregar', () => {
    ...
    it('filtra líderes pelo clube e role', async () => {
      ...
      const perfis = mocks.supabase.builderDe('profiles')
  ...
  describe('salvar', () => {
    it('atualiza o substituto quando já existe remanejamento', async () => {
      ...
      const bRem = mocks.supabase.builderDe('remanejamentos_temporarios')
    ...
    it('insere um novo remanejamento quando não existe', async () => {
      ...
      mocks.supabase.builderDe('remanejamentos_temporarios').singleData = novo
  ...
  describe('remover', () => {
    ...
    it('não chama o banco quando não existe remanejamento', async () => {
      ...
      expect(mocks.supabase.builderDe('remanejamentos_temporarios').delete).not.toHaveBeenCalled()
    })
  })
})
